...
namespace splicer
{
  namespace ffi
  {
    ...
    ::std::unique_ptr<Value> HostObject_get(
        ::facebook::jsi::HostObject &self, Runtime &rt, const PropNameID &name) noexcept
    {
      Value (::facebook::jsi::HostObject::*data$)(facebook::jsi::Runtime &, const facebook::jsi::PropNameID &name) = &::facebook::jsi::HostObject::get;
    ...
    ::std::unique_ptr<std::vector<PropNameID>> HostObject_getPropertyNames(
        ::facebook::jsi::HostObject &self, Runtime &rt) noexcept
    {
      std::vector<PropNameID> (::facebook::jsi::HostObject::*data$)(facebook::jsi::Runtime &) = &::facebook::jsi::HostObject::getPropertyNames;
    ...
    ::std::shared_ptr<ConstPreparedJavaScript> PreparedJavaScript_asConst(
        const ::std::shared_ptr<PreparedJavaScript> &js) noexcept
    {
    ...
    ::std::unique_ptr<Value> Runtime_evaluateJavaScript(
        ...
        rust::Str sourceURL) noexcept
    {
      Value (::facebook::jsi::Runtime::*data$)(
          const std::shared_ptr<const Buffer> &buffer,
          const std::string &sourceURL) = &::facebook::jsi::Runtime::evaluateJavaScript;
        ...
        rust::Str sourceURL) noexcept
    {
      std::shared_ptr<ConstPreparedJavaScript> (::facebook::jsi::Runtime::*data$)(
          const std::shared_ptr<const Buffer> &buffer,
          const std::string sourceURL) = &::facebook::jsi::Runtime::prepareJavaScript;
      return (self.*data$)(buffer, std::string(sourceURL));
    }

    ::std::unique_ptr<Value> Runtime_evaluatePreparedJavaScript(
        ::facebook::jsi::Runtime &self,
        const ::std::shared_ptr<ConstPreparedJavaScript> &js) noexcept
    {
      Value (::facebook::jsi::Runtime::*data$)(
          const ::std::shared_ptr<ConstPreparedJavaScript> &) = &::facebook::jsi::Runtime::evaluatePreparedJavaScript;
      auto value = (self.*data$)(::std::shared_ptr<ConstPreparedJavaScript>(js));
      return ::std::make_unique<Value>(std::move(value));
    }

    ::std::unique_ptr<Object> Runtime_global(
        ::facebook::jsi::Runtime &self) noexcept
    {
    ...
    ::std::unique_ptr<std::string> Runtime_description(
        ::facebook::jsi::Runtime &self) noexcept
    {
      std::string (::facebook::jsi::Runtime::*fp)() = &::facebook::jsi::Runtime::description;
      auto value = (self.*fp)();
    ...
    ::std::unique_ptr<PropNameID> PropNameID_forUtf8(
        Runtime &rt,
        rust::Str str) noexcept
    {
      auto value = PropNameID::forUtf8(rt, (const uint8_t *)str.data(), str.length());
      return std::make_unique<PropNameID>(std::move(value));
    }

    ::std::unique_ptr<PropNameID> PropNameID_forString(
        Runtime &rt,
    ...
    ::std::unique_ptr<std::string> PropNameID_toUtf8(
        const PropNameID &self,
        Runtime &rt) noexcept
    {
      std::string (::facebook::jsi::PropNameID::*fp)(Runtime & rt) const = &::facebook::jsi::PropNameID::utf8;
    ...
    bool PropNameID_compare(
        Runtime &rt,
        const PropNameID &self,
        const PropNameID &other) noexcept
    {
    ...
    ::std::unique_ptr<std::string> Symbol_toString(
        const Symbol &self,
        Runtime &rt) noexcept
    {
      std::string (::facebook::jsi::Symbol::*fp)(Runtime & rt) const = &::facebook::jsi::Symbol::toString;
      auto value = (self.*fp)(rt);
      return std::make_unique<std::string>(std::move(value));
    }
    ...
    ::std::unique_ptr<String> String_fromUtf8(
        Runtime &rt,
        rust::Str str) noexcept
    {
      auto value = String::createFromUtf8(rt, (const uint8_t *)str.data(), str.length());
      return std::make_unique<String>(std::move(value));
    }

    ::std::unique_ptr<std::string> String_toString(
        const String &self,
        Runtime &rt) noexcept
    {
      std::string (::facebook::jsi::String::*fp)(Runtime & rt) const = &::facebook::jsi::String::utf8;
      auto value = (self.*fp)(rt);
      return std::make_unique<std::string>(std::move(value));
    }
    ...
    ::std::unique_ptr<Object> Object_create(
        Runtime &rt) noexcept
    {
    ...
    std::unique_ptr<Value> Object_getProperty(
        const Object &self,
        Runtime &rt,
        const PropNameID &name) noexcept
    {
      Value (::facebook::jsi::Object::*fp)(Runtime &, const PropNameID &) const = &::facebook::jsi::Object::getProperty;
    ...
    void Object_setProperty(
        ...
        std::unique_ptr<Value> value) noexcept
    {
      void (::facebook::jsi::Object::*fp)(Runtime &, const PropNameID &, Value &) = &::facebook::jsi::Object::setProperty;
      auto v = std::move(*value);
      (self.*fp)(rt, name, v);
    }

    std::unique_ptr<Array> Object_asArray(
        Object const &self,
        Runtime &rt)
    {
      Array (::facebook::jsi::Object::*fp)(Runtime &) const & = &::facebook::jsi::Object::asArray;
      auto val = (self.*fp)(rt);
      return std::make_unique<Array>(std::move(val));
    }

    std::unique_ptr<ArrayBuffer> Object_asArrayBuffer(
        Object const &self,
        Runtime &rt)
    {
      ArrayBuffer (::facebook::jsi::Object::*fp)(Runtime &) const & = &::facebook::jsi::Object::getArrayBuffer;
      auto val = (self.*fp)(rt);
      return std::make_unique<ArrayBuffer>(std::move(val));
    }

    std::unique_ptr<Function> Object_asFunction(
        Object const &self,
        Runtime &rt)
    {
      Function (::facebook::jsi::Object::*fp)(Runtime &) const & = &::facebook::jsi::Object::asFunction;
      auto val = (self.*fp)(rt);
      return std::make_unique<Function>(std::move(val));
    }

    std::shared_ptr<HostObject> Object_asHostObject(
        Object const &self,
        Runtime &rt)
    {
      std::shared_ptr<HostObject> (::facebook::jsi::Object::*fp)(Runtime &) const = &::facebook::jsi::Object::asHostObject;
      return (self.*fp)(rt);
    }

    std::unique_ptr<Array> Object_getPropertyNames(
        Object &self,
        Runtime &rt)
    {
      Array (::facebook::jsi::Object::*fp)(Runtime &) const = &::facebook::jsi::Object::getPropertyNames;
      auto val = (self.*fp)(rt);
      return std::make_unique<Array>(std::move(val));
    }
    ...
    std::unique_ptr<WeakObject> WeakObject_fromObject(Runtime &rt, Object const &object)
    {
      return std::make_unique<WeakObject>(rt, object);
    }

    std::unique_ptr<Value> WeakObject_lock(
        WeakObject &self,
        Runtime &rt)
    {
      Value (::facebook::jsi::WeakObject::*fp)(Runtime &) = &::facebook::jsi::WeakObject::lock;
      auto val = (self.*fp)(rt);
    ...
    std::unique_ptr<Array> Array_createWithLength(
        Runtime &rt,
        size_t length)
    {
    ...
    std::unique_ptr<Value> Array_get(
        Array const &self,
        Runtime &rt,
        size_t index)
    {
      Value (::facebook::jsi::Array::*fp)(Runtime &, size_t) const = &::facebook::jsi::Array::getValueAtIndex;
    ...
    std::unique_ptr<Value> Function_call(
        Function const &self,
        Runtime &rt,
        std::vector<Value> const &args)
    {
      Value (::facebook::jsi::Function::*fp)(Runtime &, Value const *, size_t) const = &::facebook::jsi::Function::call;
    ...
    std::unique_ptr<Value> Function_callWithThis(
        Function const &self,
        Runtime &rt,
        Object const &thisObj,
        std::vector<Value> const &args)
    {
      Value (::facebook::jsi::Function::*fp)(Runtime &, Object const &, Value const *, size_t) const = &::facebook::jsi::Function::callWithThis;
    ...
    std::unique_ptr<Value> Function_callAsConstructor(
        ...
        std::vector<Value> const &args)
    {
      Value (::facebook::jsi::Function::*fp)(Runtime &, Value const *, size_t) const = &::facebook::jsi::Function::callAsConstructor;
      auto value = (self.*fp)(rt, args.data(), args.size());
      return std::make_unique<Value>(std::move(value));
    }
        ...
        void *closure)
    {
      auto value = Function::createFromHostFunction(
          rt, name, paramCount,
          [closure](Runtime &rt, const Value &thisVal, const Value *args, size_t count)
          {
            auto stride = sizeof(Value);
            auto val = host_fn_trampoline(rt, thisVal, args, count, stride, closure);
    ...
    {
      auto val = Value::createFromJsonUtf8(rt, (const uint8_t *)s.data(), s.length());
      return std::make_unique<Value>(std::move(val));
    }
    ...
    {
      String (::facebook::jsi::Value::*fp)(Runtime &) const & = &::facebook::jsi::Value::asString;
      auto val = (self.*fp)(rt);
    ...
    {
      Symbol (::facebook::jsi::Value::*fp)(Runtime &) const & = &::facebook::jsi::Value::asSymbol;
      auto val = (self.*fp)(rt);
    ...
    {
      Object (::facebook::jsi::Value::*fp)(Runtime &) const & = &::facebook::jsi::Value::asObject;
      auto val = (self.*fp)(rt);
    ...
    {
      String (::facebook::jsi::Value::*fp)(Runtime &) const = &::facebook::jsi::Value::toString;
      auto val = (self.*fp)(rt);
      return std::make_unique<String>(std::move(val));
    }
    ...
    void CallInvoker_invokeSync(std::shared_ptr<facebook::react::CallInvoker> ci, void *closure)
    {
      ci->invokeSync([closure]()
                     { call_invoker_trampoline(closure); });
    }

    void CallInvoker_invokeAsync(std::shared_ptr<facebook::react::CallInvoker> ci, void *closure)
    {
      ci->invokeAsync([closure]()
                      { call_invoker_trampoline(closure); });
    }
    ...
    void push_prop_name_vector(std::vector<PropNameID> &values, std::unique_ptr<PropNameID> value)
    {
      auto x = std::move(*value.release());
      values.push_back(std::move(x));
    }
